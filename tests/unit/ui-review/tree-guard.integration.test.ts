...
// Node no entrega señales POSIX reales a los hijos en Windows: child.kill
//("SIGINT") ahí solo termina el proceso a la fuerza, sin darle nunca la
// oportunidad de correr su propio listener (comprobado a mano: un hijo con
